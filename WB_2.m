...
%%
warning('off','all');
fname = 'List of Investable companies.txt';
fname2 = 'List of non-Investable companies.txt';
fileID = fopen(fname, 'at' );
fileID2 = fopen(fname2, 'at' );

c = ['Company','	EpSY1	EpSY2	EpSY3	EpSY4	EpSY5	MarketCap	Equity	Slope	P/E	RevY1	RevY2	RevY3	RevY4	RevY5	SlopeR	ProfY1	ProfY2	ProfY3	ProfY4	ProfY5	currency	RoEY1	RoEY2	RoEY3	RoEY4	RoEY5'];
fprintf(fileID,c);
c = ['Company','	EpSY1	EpSY2	EpSY3	EpSY4	EpSY5	MarketCap	Equity	Slope	P/E	RevY1	RevY2	RevY3	RevY4	RevY5	SlopeR	ProfY1	ProfY2	ProfY3	ProfY4	ProfY5	currency	RoEY1	RoEY2	RoEY3	RoEY4	RoEY5'];
fprintf(fileID2,c);
